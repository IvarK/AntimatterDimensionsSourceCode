...
Vue.component("v-tab", {
  ...
  methods: {
    update() {
      ...
      this.canReduce = this.pp > 20000 &&
        player.celestials.v.ppSpent < 2000000 * player.celestials.v.runUnlocks.max();
    ...
    reduceGoals() {
      ...
      player.reality.pp -= 20000;
      player.celestials.v.ppSpent += 20000;
    }
  },
  computed: {
      ...
      <div v-else>
        ...
        <div v-if="showReduction">
          <button
            ...
            @click="reduceGoals()">
              Spend {{ format(20000) }} PP to reduce all goals by 1% of a tier
          </button>
          <br>
