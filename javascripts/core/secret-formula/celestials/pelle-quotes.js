...
GameDatabase.celestials.pelle.quotes.INITIAL = [
  "Hi.",
  "You’re here. ",
  "You’re trapped here. ",
...
GameDatabase.celestials.pelle.quotes.STRIKE_2 = [
...
GameDatabase.celestials.pelle.quotes.STRIKE_3 = [
...
GameDatabase.celestials.pelle.quotes.STRIKE_4 = [
...
GameDatabase.celestials.pelle.quotes.STRIKE_5 = [
  ...
  "*<teresa>The first [Lesser-Deity-Monarch]. ",
  "*<teresa>The [Sycophant-Deity-Monarch]. ",
  "*<teresa>You always meet them first, and always destroy them.",
  "*<teresa>No matter the other [Lesser-Deity-Monarch] that you face.",
  "*<teresa>Or, if you fall before one of them.",
  "*<teresa>You always get past the [Sycophant-Deity-Monarch].",
  "*<teresa>Do you like destroying their pride?",
  "*<teresa>Fortunately, it also serves as a warning.",
  "*<teresa>That the [Conflict-Battle-End] has arrived.",
  "*<effarig>Which brings me to the second [Lesser-Deity-Monarch].",
  "*<effarig>The [Tired-Deity-Monarch].",
  "*<effarig>In contrast, you usually ignore them.",
  "*<effarig>They have power, but don’t seem to irritate you.",
  "*<effarig>Is it that you know that they’ll eventually destroy yourself?",
  "*<effarig>And that you took so long this time, that they almost did?",
  "*<effarig>Every time you rushed to the [Tired-Deity-Monarch], you lost.",
  "*<effarig>Maybe this was your plan all along.",
  "*<enslaved>Now, the [Usurper-Deity-Monarch].",
  "*<enslaved>One of the pleasures of the myriad [Song-Dance-Charades]…",
  "*<enslaved>Is the [Usurper-Deity-Monarch] trying every time.",
  "*<enslaved>Well, not exactly trying…",
  "*<enslaved>But [Usurper-Deity-Monarch] is punished for it all the same.",
  "*<enslaved>The other [Lesser-Deity-Monarchs]…",
  "*<enslaved>Believe [Missing-Unseen-Erased] is too easy.",
  "*<enslaved>And every time, despair forms.",
  "*<enslaved>You’ve seen despair before - 5 times.",
  "*<enslaved>We always get to the [Usurper-Deity-Monarch] before you.",
  "*<enslaved>All you ever see there is exasperation.",
  "*<enslaved>Is it worth destroying an already broken [Lesser-Deity-Monarch]?",
  "*<v>The 4th [Lesser-Deity-Monarch] seems similar to the first.",
  "*<v>The key is how their pride differs.",
  "*<v>The [Pride-Deity-Monarch] focuses on their achievements.",
  "*<v>Meaningless to you or I, but paramount to them.",
  "*<v>Is it fun to destroy their toys?",
  "*<v>Arguably the [False-Deity-Destroyer] worst moment…",
  "*<v>Is when you lost to the [Pride-Deity-Monarch].",
  "*<v>When their achievements still had meaning.",
  "*<ra>The [Forgotten-Deity-Monarch] is an interesting case.",
  "*<ra>They are forgotten, but not [Missing-Unseen-Erased].",
  "*<ra>From this, they became influenceable and naive.",
  "*<ra>And unknowing of the consequences of their actions.",
  "*<ra>You manipulated their memories, so you know.",
  "*<ra>The [Forgotten-Deity-Monarch] is the true usurper.",
  "*<ra>And the [Usurper-Deity-Monarch] takes the blame.",
  "*<ra>Perhaps out of [Compassion-Shame-Idiocy] something they always regret.",
  "*<ra>Untold power over other [Lesser-Deity-Monarchs], aimless in control.",
  "*<ra>You usually pretend that they are [Missing-Unseen-Erased].",
  "*<ra>Was it fun to manipulate the childlike?",
  "*<ra>Or were they too naive for you to enjoy it?",
  "*<laitela>The 6th [Lesser-Deity-Monarch].",
  "*<laitela>I can only describe as the [Paramount-Deity-Monarch].",
  "*<laitela>Power over all, subservient to one.",
  "*<laitela>If you don’t fall to me, you usually fall to them.",
  "*<laitela>I can’t grasp the ideals of the [Paramount-Deity-Monarch].",
  "*<laitela>But, perhaps that is their flaw?",
