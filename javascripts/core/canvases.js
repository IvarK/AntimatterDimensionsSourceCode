...
function drawPerkNetwork() {
    ...
    {id: 3, label: "3", color: getNodeColor(3, 1), title: "Improve the automator row per reality scaling."},
    {id: 4, label: "4", color: getNodeColor(4, 1), title: "EC1 requirement removed from study 181"},
    ...
    {id: 14, label: "14", color: getNodeColor(14, 1), title: "Keep second row of dilation upgrades on reality."},
    {id: 15, label: "15", color: getNodeColor(15, 1), title: "Keep third row of dilation upgrades on reality."},
