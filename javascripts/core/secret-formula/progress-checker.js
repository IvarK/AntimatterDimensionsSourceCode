...
GameDatabase.progressStages = [
  ...
  },
  {
    ...
    hasReached: save => save.celestials.teresa.quotes.length > 0,
    suggestedResource: "Reality Machines",
  ...
  },
  {
    ...
    hasReached: save => save.celestials.effarig.quotes.length > 0,
  ...
  },
  {
    ...
    hasReached: save => save.celestials.enslaved.quotes.length > 0,
  ...
  },
  {
    ...
    hasReached: save => save.celestials.v.quotes.length > 0,
  ...
  },
  {
    ...
    hasReached: save => save.celestials.ra.quotes.length > 0,
  ...
  },
  {
    ...
    hasReached: save => save.celestials.laitela.quotes.length > 0,
