...
`,
      ...
      name: "Reality",
      info: () => `
When you reach ${format(5e9)} time theorems, ${formatPostBreak(DC.E4000)} EP, and have completed the first
...
${formatPostBreak(DC.E2000)} Reality Machines will allow you to unlock the next Celestial.`,
...
a total of ${formatInt(100)} Ra levels, and spending ${formatPostBreak(DC.E2000)} Reality Machines.
<br>
<br>
