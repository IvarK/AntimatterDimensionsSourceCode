...
GameDatabase.reality.upgrades = (function() {
  ...
  return [
    ...
    rebuyable({
      name: "Amplification of Paradoxes",
      id: 4,
      initialCost: 2,
      costMult: 30,
