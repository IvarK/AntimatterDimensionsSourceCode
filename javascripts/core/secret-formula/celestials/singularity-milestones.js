...
GameDatabase.celestials.singularityMilestones = {
  ...
  darkAutobuyerSpeed: {
    ...
    repeat: 650,
    limit: 8,
    description: "Autobuyer speed for DMD upgrades",
    effect: completions => [30, 20, 15, 10, 5, 3, 2, 1, 0][completions],
    effectFormat: x => (x === 0 ? "Instant" : `${formatInt(x)}s`),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ascensionAutobuyerSpeed: {
    start: 3e8,
    repeat: 390,
    limit: 6,
    description: "Autobuyer speed for DMD Ascension",
    effect: completions => [15, 10, 5, 3, 2, 1, 0][completions],
    effectFormat: x => (x === 0 ? "Instant" : `${formatInt(x)}s`),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  realityDEMultiplier: {
