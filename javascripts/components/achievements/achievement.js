...
const achDetails = [
  ...
  { name: "The first one's always free", imageId: 1, tooltip: () => undefined },
  { name: "Just in case", imageId: 1, tooltip: () => undefined },
  { name: "It pays to have respect", imageId: 1, tooltip: () => undefined },
  { name: "So do I", imageId: 1, tooltip: () => undefined },
  { name: "Do a barrel roll!", imageId: 1, tooltip: () => undefined },
  { name: "Do you enjoy pain?", imageId: 1, tooltip: () => undefined },
  { name: "30 Lives", imageId: 1, tooltip: () => undefined },
  { name: "Do you feel lucky? Well do ya punk?", imageId: 1, tooltip: () => undefined },
  { name: "Go study in real life instead", imageId: 1, tooltip: () => undefined },
  { name: "Cancer = Spread", imageId: 1, tooltip: () => undefined },
  { name: "Stop right there criminal scum!", imageId: 1, tooltip: () => undefined },
  { name: "Real news", imageId: 1, tooltip: () => undefined },
  { name: "Shhh... It's a secret", imageId: 1, tooltip: () => undefined },
  { name: "You're a failure", imageId: 1, tooltip: () => undefined },
  { name: "It's not called matter dimensions is it?", imageId: 1, tooltip: () => undefined },
  { name: "Nice.", imageId: 1, tooltip: () => undefined },
  { name: "You should download some more RAM", imageId: 1, tooltip: () => undefined },
  { name: "Less than or equal to 0.001", imageId: 1, tooltip: () => undefined },
  { name: "A sound financial decision", imageId: 1, tooltip: () => undefined },
  { name: "You do know how these work, right?", imageId: 1, tooltip: () => undefined },
  { name: "Should we tell them about buy max...", imageId: 1, tooltip: () => undefined },
  { name: "While you were away... Nothing happened.", imageId: 1, tooltip: () => undefined },
  { name: "You followed the instructions", imageId: 1, tooltip: () => undefined },
  { name: "Professional bodybuilder", imageId: 1, tooltip: () => undefined },
  { name: "That dimension doesn’t exist", imageId: 1, tooltip: () => undefined },
  { name: "Was it even broken?", imageId: 1, tooltip: () => undefined },
  { name: "Time fixes everything", imageId: 1, tooltip: () => undefined },
  { name: "Are you statisfied now?", imageId: 1, tooltip: () => undefined },
  { name: "This dragging is dragging on", imageId: 1, tooltip: () => undefined },
  { name: "s46", imageId: 1, tooltip: () => undefined },
  { name: "s47", imageId: 1, tooltip: () => undefined },
  { name: "s48", imageId: 1, tooltip: () => undefined }
];