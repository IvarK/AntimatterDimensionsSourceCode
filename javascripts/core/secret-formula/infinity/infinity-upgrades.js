  ...
  return {
    totalTimeMult: {
      ...
      charged: {
        ...
        effect: () => 1 +
          ...
          Math.pow(Ra.teresaLevel, 0.5) / 150,
    ...
    resetBoost: {
      ...
      charged: {
        ...
        effect: () => 1 / (1 + Math.sqrt(Ra.teresaLevel) / 10),
    ...
    galaxyBoost: {
      ...
      charged: {
        ...
        effect: () => 2 + Math.sqrt(Ra.teresaLevel) / 100,
    ...
    unspentIPMult: {
      ...
      charged: {
        ...
        effect: () => player.infinityPoints.dividedBy(2).pow(Math.sqrt(Ra.teresaLevel) * 1.5).plus(1),
        formatEffect: value => formatX(value, 2, 2)
      }
    },
    dimboostMult: {
