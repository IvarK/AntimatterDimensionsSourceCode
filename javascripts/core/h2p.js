...
const H2P_TABS = [
  {
    ...
    and an extra 1.002× on top of that past 800 non-replicanti galaxies.) <br><br>
    <b>Hotkey: G</b>`,
    unlock: () => true,
    ...
    <b>Hotkey: S</b>`,
    unlock: () => Sacrifice.isUnlocked || PlayerProgress.infinityUnlocked,
    ...
    unlock: () => PlayerProgress.infinityUnlocked || player.galaxies > 0,
    tags: ["crunch", "big", "upgrades", "ip", "reset", "prestige", "earlygame"],
    tab: "infinity/upgrades"
  }, {
    name: "Challenges",
    id: 7,
    info: () => `Challenges are unlocked after first infinity;
    they change in-game mechanics in different ways to create more difficult infinity circumstances. <br><br>
    ...
    and they can be exited at any time via the “Exit Challenge” button on the challenge tab. <br><br>
    ...
    They are located under the infinty tab in "Autobuyers". <br><br>
    ...
    buying order randomly. <br><br>
    <b>Autobuyer Speed:</b>The cooloff period before the autobuyer makes another puchase.
    This rounds up to the nearest 100ms, so 200ms and 101ms are the same speed. <br><br>
    <b>Bulk Buy:</b> Once the Speed of an Autobuyer is maxed, all future
    upgrades will double the amount the autobuyer purchases per tick. This can be disabled. <br><br>
    <b>Dimension Autobuyer Buy Quantity:</b> Autobuyers for dimensions can be set to buy a single,
    or until 10, on each cooldown. Bulk buy does not work when the autobuyer is set to singles. <br><br>
    <b>Tickspeed Autobuyer Buy Quantity:</b> The tickspeed autobuyer can be set to buy a
    single or the max available on each cooldown. <br><br>
    ...
    the ability to buy dimboosts in bulk (at a fixed amount). <br><br>
    <b>Max Galaxies:</b> The highest amount of galaxies the galaxies autobuyer will buy. <br><br>
    <b>IP on crunch:</b> Once you break Infinity,
    you can set how many IP you would like to wait for before crunching.
    It accepts e notation (12.34e5 is 1234000). <br><br>
    <b>Sacrifice Autobuyer:</b> This autobuyer has a maxed timer from the start.
    You can set how much multiplier it waits for before sacrificing. It accepts e notation. <br><br>
    The double autobuyer tick speed upgrade will have all autobuyers buy twice as fast.<br><br>
    <b>Toggle All Autobuyers:</b> This button will turn all of your autobuyers on or off.
    If dimension autobuyer 1-6 are on, but 7, 8, and tickspeed aren't, it will turn on 7, 8, and tickspeed. <br><br>
    ...
    name: "Break Infinity",
    id: 9,
    info: () => `Originally Antimatter Dimensions was restricted by "Infinity".
    ...
    id: 10,
    info: () => `<b>Unlocking Infinity Dimensions:</b>Infinity Dimensions are unlocked by
    reaching a certain amount of antimatter. <br><br>
    <b>Infinity Dimension Cost:</b>Infinity dimensions are only purchasable in sets of 10,
    and cost Infinity points. <br><br>
    ...
    which translates to an overall multiplier on all original dimensions. <br><br>
    ...
    id: 11,
    // This one could use some work!
    info: () => `Infinity Challenges are like regular challenges, but they have higher end goals
    and are generally harder than regular challenges (but have a different kind of reward). <br><br>
    They unlock at set amounts of antimatter - the ones unlocking later are (generally) more difficult.`,
    unlock: () => Autobuyer.bigCrunch.hasMaxedInterval || PlayerProgress.eternityUnlocked,
    tags: ["rewards", "break", "ic", "break", "midgame"],
    tab: "challenges/infinity"
  }, {
    name: "Replicanti",
    id: 12,
    info: () => `Each replicanti has an upgradable chance to update every replicanti tick.
    You will gain a bonus to infinity dimensions based on much replicanti you have. <br><br>
    ...
    Once you reach infinity replicanti, they will not continue growing. <br><br>
    ...
    especially at extremely low numbers (1-5). <br><br>
    When at low values (100-1000) (when none of the conditions above are true),
    there may be some minor variances in the expected amount of replicanti gain. <br><br>
    ...
    <b>Formulas: <br>
      ...
      if you have that time study. <br><br>
    ...
    name: "Eternity",
    id: 13,
    info: () => `Upon reaching infinity Infinity Points, you can eternity.
    Eternities will reset everything before this point except challenge times, achievements,
    and total antimatter. You also unlock a new tab. <br><br>
    You can pass infinity Infinity Points whenever.
    You will recieve more Eternity Points the nore Infinity Points you had before going Eternal. <br><br>
    ...
    id: 14,
    info: () => `To make eternities faster and more convenient,
    you will unlock various buffs as you get more eternities.
    These buffs are either making you start with something on eternity or unlock an autobuyer. <br><br>
    For the buffs at the the start of an eternity,
    you will keep the relevant statistic on the run you unlock the milestone. <br>
    eg: On 1 > 2, you will keep your autobuyers. <br><br>
    ...
    id: 15,
    info: () => `After your first eternity, you unlock Time Dimensions.
    ...
    (applying retroactively to your tickspeed mult through more galaxies). <br><br>
    ...
    name: "Time Studies",
    id: 16,
    info: () => `A Time Study is a powerful post-eternity upgrade, which costs Time Theorems.
    ...
    as you cannot get all of them even if affordable. <br><br>
    ...
    You are able to hold down shift and then click on a time study to buy all studies until that point.<br><br>
    <b>Respecs:</b> A Respec allows you to reset the upgrades you have in the tree to retreive the
    Time Theorems spent on them. It can be done for free on eternity. <br><br>
    <b>Costs:</b> <br>
    <b>Antimatter:</b> 1e20000<sup>times bought + 1</sup> <br>
    <b>Infinity Points:</b> 1e100<sup>times bought</sup> <br>
    ...
    id: 17,
    info: () => `Eternity Challenges are another set of challenges which are unlocked by the Time Study tree.
    They require a certain amount of Time Theorems to enter, plus a secondary requirement. <br><br>
    You can only complete each Eternity Challenge five times, and each completion the goal increases
    and the rewards grow stronger. <br><br>
    You do not need to have the Eternity Challenge's study unlocked for the reward to take effect. <br><br>
    There are a total of twelve Eternity Challenges,
    and each one introduces different challenges which might requirre you to change your tactics. <br>
    ...
    info: () => `Time dilation is unlocked when you purchase the 5,000 TT time study after
    ...
    Dimension multipliers’ exponents and the tickspeed multipliers’ exponent will be reduced to ^0.75. <br><br>
    ...
    You can dilate as many times as you want. <br><br>
    ...
    These galaxies are permanent except when you buy a certain Dilation Upgrade. <br><br>
    ...
    name: "Reality",
    id: 19,
    info: () => `Reality is unlocked when you reach 5 billion time theorems and 1e4000 EP.
    ...
    or wait to obtain a higher glyph level and more Reality Machines. <br><br>
    ...
    A perk point is a currency that can be spent in the Perks subtab on different Perks. <br><br>
    <b>Formulas:</b><br>
    ...
    E (a scaled value of the overflow) = (X - T) / K. Y (final glyph level output) = T + K/2 × (sqrt(1+4E) - 1)).  <br>
    <b>Reality Machines gained:</b> 1000<sup>log10(EP)/4000 - 1</sup>.`,
    unlock: () => PlayerProgress.realityUnlocked,
    tags: ["rm", "machines", "glyph", "perk", "reset", "prestige", "endgame", "lategame"],
    tab: "reality/upgrades"
  }, {
    name: "Glyphs",
    id: 20,
    info: () => `A glyph is an equippable item that can have multiple types.
    Each type has four effects.<br><br>
    ...
    you should see the glyph effects that are applied.<br>
    ...
    <font color="#b241e3">Time</font>, and <font color="#64dd17">Dilation</font>. <br><br>
    ...
    At ${format(100000)} RM, you unlock the ability to sacrifice all glyph types.<br>
    ...
    name: "Perks",
    id: 21,
    info: () => `Perks are a type of upgrade unlocked upon Reality.
    Each perk effect varies, but most are QoL (quality of life) improvements.
    All perks only require 1 perk point to buy. <br><br>
    Each Reality you gain 1 perk point which can be spent on a upgrade on the tree,
    starting with "You can now choose from 3 glyphs on reality". <br><br>
    ...
    name: "Automator",
    id: 22,
    info: () => `The Automator is unlocked upon reaching 4 Realities and grants you an achievement.
    It is like a scripting language inside the game that allows you to nearly automate the entire game.<br>
    A good place to start when beginning to use the automator is by reading the documents on the side.
    They begin to help you understand what each command does.<br><br>
    You can use as many rows as you need, and the only thing limiting you is whether
    you have certain features (like the Black Hole and Stored Time) to be able to use those commands.<br>
    ...
    and then create new. To rename a script, click the pencil next to the dropdown.<br>
    ...
    name: "Black Hole",
    id: 23,
    info: () => `The Black Hole is a time multiplying feature in-game.
    It is unlocked by buying it for 50 Reality Machines.<br><br>
    You can buy upgrades for the Black Hole by using Reality Machines.
    There are three upgrades for the Black Hole: Cooldown, Intensity, and Duration.<br><br>
    Once you reach 2 years of playtime (that two years is affected by the Black Hole),
    you unlock a Reality Upgrade that allows you to have two Black Holes. <br><br>
    ...
    When your Black Hole reaches a 0.1 second interval, that Black Hole becomes permanent.<br>
    <b>Hotkey: B</b> turns the Black Hole on and off.`,
    unlock: () => BlackHole(1).isUnlocked,
    tags: ["reality", "time", "speed", "duration", "interval", "rm", "endgame", "lategame"],
    tab: "reality/hole"
  }, {
    name: "Celestials",
    id: 24,
    info: () => `Once you get all of the Reality Upgrades, the first Celestial is unlocked.
    This opens up a new tab to the right of Reality. <br><br>
    Each Celestial has unique mechanics and upgrades,
    and you need to defeat all seven.
    To defeat a Celestial, you must enter into that Celestial's Reality, and complete it. <br><br>
    ...
    unlock: () => RealityUpgrades.allBought,
    ...
    In game, it is described as the following:<br>
    ...
    antimatter gained during the run. [(log10(antimatter)/${format(1.5e8)})<sup>12</sup>]<br><br>
    At ${format(1e18)} RM, you unlock Teresa's Eternity Point generator.
    This works like Time Study 181, in the sense that you gain 1% of your peaked EP/Min per second.<br>
    Once you are at ${format(1e21)} RM in the container, you unlock Effarig, the second Celestial.
    Additionally at ${format(1e21)} Teresa's container stops leaking RM.<br>
    ...
    Relic Shards are the currency for Effarig unlocks.<br><br>
    ...
    in how much they effect the level of glyphs gained on reality.<br><br>
    ...
    or even filtering by specific effects <br><br>
    ...
    or it picks the glyph which best matches your automatic glyph sacrifice filters.<br><br>
    ...
    Its Reality's description in game is:<br>
    <div style="text-align: center">
    ...
    The main rewards are for completing Effarig's Eternity and Reality.<br>
    Effarig's Eternity unlocks the next Celestial, The Enslaved Ones.
    It also allows Eternities to generate Infinities, and disables the Infinity Point multiplier cap in its Reality.<br>
    Completing Effarig's Reality unlocks a new glyph type: <font color="#e21717">Effarig</font> Glyphs.<br>
    Effarig Glyphs have 7 different possible effects.
    A list of these can be found <a href="https://pastebin.com/992cYUY3">here.</a><br>
    You can only have one Effarig glyph equipped at a time.`,
    unlock: () => Teresa.has(TERESA_UNLOCKS.EFFARIG),
    ...
    The button directly below it allows you instantly spend all the accumulated time.<br><br>
    ...
    or using offline time as it had been used previously(to calculate offline production).<br>
    ...
    of realities indicated by the multiplier listed on the yellow button.<br><br>
    The Enslaved Ones unlocks required having several years of stored time saved up.<br>
    Their first unlock cost, ${format(1e35)} years;
    this upgrade increases the free tickspeed softcap by 100,000 upgrades.<br>
    At ${format(1e40)} years, you are able to finally unlock its Reality, which is described as:<br>
    <div style="text-align: center">
    ...
    sprinkled throughout to help you complete it.<br>
    The reward for completing The Enslaved Ones:
    "Infinity Dimension purchase caps are increased by 1000 for every 1000 free Tickspeed upgrades."<br>`,
    ...
    which requires you to get 800 Antimatter Galaxies without buying 8th Dimensions in your current infinity.<br>
    ...
    ${format(1e320)} Dilated Time, and ${format(new Decimal("1e320000"))} Replicanti, all in the same run.<br><br>
    ...
    which contains the nerfs to V's reality, which are as follows:<br>
    <div style="text-align: center">
    ...
    V-achievements go to two different things: unlocking rewards and being able to add more studies to your tree.<br>
    V has three rewards unlockable with the V-Achievements.
    The first one requires you to have ten V-Achievements,
    and increases the speed of the Auto-EC perk by your Achievement multiplier.<br>
    The second unlockable needs thirty V-Achievements to unlock,
    and it multiplies black hole power by your achievement count.
    It also unlocks Ra, the next Celestial.<br>
    The final unlockable takes all thirty-six V-Achievements to unlock,
    and doubles the amount of locked studies you can buy.<br>
    One of V's passive unlocks is the ability to buy studies that you are not normally able to buy.
    This requires six (three with the final unlock) V-Achievements to be completed to buy one locked study.<br>`,
    unlock: () => Achievement(151).isEnabled,
