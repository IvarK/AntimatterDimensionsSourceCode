...
GameDatabase.achievements.normal = [
  ...
  },
  {
    ...
    checkRequirement: () => !NormalChallenge(8).isActuallyRunning && Sacrifice.totalBoost.gte(600),
  ...
  },
  {
    ...
    checkRequirement: () => NormalChallenge(2).isActuallyRunning && Time.thisInfinityRealTime.totalMinutes <= 3,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () => NormalChallenge(8).isActuallyRunning && Time.thisInfinityRealTime.totalMinutes <= 3,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Dimensional Sacrifice is stronger.
      ${Sacrifice.getSacrificeDescription({ "Achievement32": true, "Achievement57": false, "Achievement88": false })} ➜
  ...
  },
  {
    ...
    checkRequirement: () => NormalChallenge(9).isActuallyRunning && Time.thisInfinityRealTime.totalMinutes <= 3,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () => NormalChallenge(3).isActuallyRunning && Time.thisInfinityRealTime.totalSeconds <= 10,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  ...
  },
  {
    ...
    checkRequirement: () =>
      NormalChallenge(2).isActuallyRunning &&
