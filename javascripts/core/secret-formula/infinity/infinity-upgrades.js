  ...
  return {
    totalTimeMult: {
      ...
      charged: {
        ...
        effect: () => 1 +
          ...
          Math.pow(player.celestials.ra.teresaLevel, 0.5) / 150,
    ...
    dim18mult: {
      ...
      charged: {
        ...
        Math.sqrt(player.celestials.ra.teresaLevel) / 150,
        formatEffect: value => formatPow(value, 4, 4)
      }
    },
    dim27mult: {
    ...
    resetBoost: {
      ...
      charged: {
        ...
        effect: () => 1 / (1 + Math.sqrt(player.celestials.ra.teresaLevel) / 10),
    ...
    buy10Mult: {
      ...
      charged: {
        ...
        effect: () => 1 + player.celestials.ra.teresaLevel / 200,
    ...
    galaxyBoost: {
      ...
      charged: {
        ...
        effect: () => 2 + Math.sqrt(player.celestials.ra.teresaLevel) / 100,
    ...
    unspentIPMult: {
      ...
      charged: {
        ...
        effect: () => player.infinityPoints.dividedBy(2).pow(Math.sqrt(player.celestials.ra.teresaLevel) * 1.5).plus(1),
        formatEffect: value => formatX(value, 2, 2)
      }
    },
    dimboostMult: {
