...
GameDatabase.news = [
  ...
  {
    id: "a41",
    text: "There always must be equal matter than there is antimatter, I guess your mom balances that a bit."
  },
  {
    id: "a42",
  ...
  },
  {
    id: "a174",
    text:
      "<span style='font-family: runescape; color: yellow; text-shadow: 1px 1px black; letter-spacing: 0.1rem; " +
      "font-size: 2rem; line-height: 0; animation: text-flash 1s steps(1, end) infinite;'>FREE RUNE ARMOR TRIMMING " +
      "</span>"
  },
  {
    id: "a175",
  ...
  },
  {
    ...
    text:
      ...
      "̷̨̨̡̙̩͚̆̈̿̉̒Ḁ̷̛͂̈́͗̎̃̓͛́͘ͅW̶̡̖͓̗̦̃̇̌̀͝A̵͇̭͉̓̎̈̿̊́̄̚͜R̶̝͚̲̭͎͇͎͓͖͚͇̀̈́͗̃̏̂̌͝͝Ę̴̡̤͙͈̝̬̰͒͘</span><span style" +
  ...
  },
  {
    ...
    get unlocked() { return Enslaved.isRunning &&
      player.thisRealityRealTime > TimeSpan.fromHours(2).totalMilliseconds; }
  },
  {
    id: "e2",
  ...
  },
  {
    id: "e4",
    get text() {
      return "You can't get <span style='color: black; background: black;'>REDACTED</span>? You couldn't get those anyway, why do you care?";
    },
    get unlocked() { return Enslaved.isRunning &&
      player.thisRealityRealTime > TimeSpan.fromHours(2).totalMilliseconds; }
  },
  {
    ...
    get unlocked() { return Enslaved.isRunning &&
      player.thisRealityRealTime > TimeSpan.fromMinutes(15).totalMilliseconds; }
  },
  {
    id: "e6",
    get text() {
