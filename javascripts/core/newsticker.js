...
["Antimatter ghosts do not exist. Just like matter ghosts. They don't have any matter, for that matter.", true, "a2"],
["Nuclear power plants have been abandoned in favor of antimatter power.", true, "a3"],
["Antimatter cookies have been confirmed to not exist, whoever claims that, stop.", true, "a4"],
...
["How does it matter if it's antimatter?", true, "a10"],
...
["My dog ate too much antimatter, now he's' saying 'meow!'", true, "a46"],
...
["This world situation is an SOS situation to the world!! MAYDAY, MAYDAY!!", true, "a54"],
...
["Antimatter is like the internet. If you're reading this, you can't have enough of it.",  true, "a98"],
...
["Attention all Antimatter Dimensions Gamers, Hevipelle is in great danger, and he needs YOUR help to wipe out all the bad memes in #news-ticker-suggestions. To do this, he needs a dozen new dank memes and a couple of discord bots. To help him, all he needs is your Antimatter card number, the three numbers on the back, and the expiration month and date. But you gotta be quick so that Hevipelle can secure the good memes, and achieve the epic meme R O Y A L.", true, "a139"],
["If each Trimp was a plank volume, and each piece of resource was a plank volume, how many universes would you fill up before you realized you were playing the wrong game?", true, "a140"],
["Actually, that last one was incorrect.", true, "a141"],
["If you're reading this, you can read.", true, "a142"],
["@everyone", true, "a143"],
['The game "Matter Dimensions" by Lghtellep has just reached -1,000,000 plays on the gaming website Etagergnok.', true, "a144"],
["How many licks does it take to get to the center of a antimatter tootsie pop? A whole lot, because unless you're made out of antimatter too, you'll explode every time you try to lick it.", true, "a145"],
["They say if you look in a mirror and ping Hevipelle three times in a row you'll instantly die.", true, "a146"],
["The next update is now only 300 minutes away.", true, "a147"],
["🤔", true, "a148"],
["Game is Dead 1/5 the moderation is terrible.", true, "a149"],
["This message will never appear on the news ticker, isn't that cool?", true, "a150"],
["The first dimension produces antimatter, the second dimension produces the first dimension, the third dimension produces the second dimension, the fourth dimension produces the third dimension. Nobody has ever unlocked the 5th, because that would take more than a minute of gameplay.", true, "a151"],
["My AD-blocker won't let me play.", true, "a152"],
...
["Antimatter people seem to be even more afraid of 13 then we are. They destroyed entire galaxies just to remove 13 from their percents.", "player.galaxies > 0 || player.infinitied > 0", "b6"],
["To understand dimensional sacrifice, you do actually need a PhD in theoretical physics. Sorry!", "player.sacrificed.e >= 10 || player.resets >= 6", "b7"],
["A new group for the standardisation of numbers have come forward with a novel new format involving emoji's.", "player.spreadingCancer > 0", "b8"],
["Antimatter ice cream stand has recently opened- they have octillions of flavors!", "player.totalmoney.e >= 27", "b9"],
["The Heavenly Pelle has generated too much antimatter and needed to create another galaxy. This one can be seen in the southwestern sky.", "player.galaxies > 0 || player.infinitied > 0", "b10"],
["What does the CTRL button do again?", "controlDown", "b11"],
//9th dim
["9th Dimension is a lie.", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b12"],
["The square root of 9 is 3, therefore the 9th dimension can't exist.", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b13"],
["You got assimilated by the 9th dimension? Just call your doctor for mental illness!", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b14"],
["Why is there no 9th dimension? Because 7 8 9.", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b15"],
["The 9th dimension cannot exist because the Nein-speaking nazis died in WW2.", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b16"],
["If you break the fourth wall... well, there's still the fifth, sixth, seventh, and eighth to get through before you encounter bad things, so you should be fine", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b17"],
["Conditions must be met for Hevipelle to sleep. First, it needs to be a blue moon. Second, a specific town in the arctic must have not seen light for a month. Third, he needs to release an AD update. And finally, no one on the Discord can be on dimension 9. Only then can he rest, for up to 6 hours, before waking up forcefully to avoid getting the offline achievement.", (player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0) && player.achievements.includes("r22"), "b18"],
["If the 9th dimension is all evil, then is 3 the root of all evil?", "player.resets >= 5 || player.galaxies > 0 || player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b19"],
//basic (post-inf pre-rep)
["Infinity: the one thing that's supposed to break.", "player.infinitied > 0 || player.eternities > 0 || player.realities > 0", "b20"],
["I've got 1.79e308 problems, but none of them antimatters", "player.infinitied > 0 && !player.break", "b21"],
["Anti Emoji Movie a huge hit", "player.spreadingCancer >= 5", "b18"],
["If this game was made by Valve, Zero Deaths would be impossible.", 'player.achievements.includes("r43")', "b22"],
["Florida man attempts to get Zero Deaths on first run, is stopped by heat death of the universe.", 'player.achievements.includes("r43")', "b23"],
["Having done half the achievements isn't much of an achievement -Boo"," player.achievements.length >= 40", "b24"],
//basic (post-rep)
["Thanos is gonna be super dissapointed when he shows up with a fully powered infinity gauntlet, and Hevi has a fully powered eternity gauntlet", "player.eternities > 0 || player.realities > 0", "b25"],
["New strange material was been found. It seems to grow exponentially, but only helps with antimatter production.", "player.replicanti.unl && player.replicanti.chance == 0.01", "b26"],
["It seems this \"replicanti\" stuff won't be growing any faster now.", "player.replicanti.chance == 1 && player.replicanti.interval == 1", "b27"],
//newsarray
["Does Hevi just pick quotes to put into the game?", "player.newsArray.length >= 30", "n1"],
["New news company has become rivals with us. They are made entirely of antimatter.", "player.newsArray.length >= 80", "n2"],
["How many times can we use \"Anti\" in a row before people stop listening?", "player.newsArray.length >= 100", "n3"],
["Does Hevi even check #news-ticker-suggestions anymore?", "player.newsArray.length >= 120", "n4"],
["Need more quotes! -hevipelle", "player.newsArray.length >= 135", "n5"],
["Man destroys known universe with antimatter, writes news tickers to keep from feeling lonely.", "player.newsArray.length >= 150", "n6"],
["You're almost there!", "player.newsArray.length >= 160", "n7"],
["You can stop now", "player.newsArray.length >= 165", "n8"],
["fucking hacker", "player.newsArray.length >= 200", "n9"],
["Asian man trys to steal the trophy of fastest infinty of -1 seconds, AND HE DOES IT!", 'player.newsArray.includes("c1")', "n10"],
["I broke the 8th wall, there is only chaos, Slabdrill is ritually sacrificing antimatter to the 9th dimension. This will be my last entry, may Hevipelle have mercy on our souls, we didn't listen, We should have listened.", 'player.newsArray.includes("b22")', "n11"],
["I thought the update was 5 hours away... -new players after more than 5 hours of gameplay", 'player.newsArray.includes("a91") && player.totalTimePlayed >= 60000*300', "n12"],
["Somebody told me to wait five hours for the update yesterday but it's today and it still hasn't come! What do I do?", 'player.newsArray.includes("a91") && player.totalTimePlayed >= 60000*300', "n13"],
//hard
...
["Did you use an autoclicker for that?", "player.timestudy.studies.includes(131) && player.thisInfinityTime <= 60000 && player.replicanti.galaxies >= 50", "c5"],
