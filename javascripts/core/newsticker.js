...
//basic (post-inf pre-rep)
  ...
  ["If this game was made by Valve, Zero Deaths would be impossible.", "b22", () => player.achievements.has("r43")],
  ["Florida man attempts to get Zero Deaths on first run, is stopped by heat death of the universe.", "b23", () => player.achievements.has("r43")],
...
//missable / pay req
  ["How dare you actually get zero deaths on a first run?", "s1", () => player.achievements.has("r43") && player.infinitied.eq(1) && player.eternities === 0],
