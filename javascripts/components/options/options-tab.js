  ...
  template:
    `<div class="l-options-tab">
      ...
      <p>
        ...
        <br>
        S for sacrifice, D for Dimension Boost, G for Antimatter Galaxy, C for Big Crunch, A for toggle autobuyers, R for Replicanti galaxies, E for Eternity, and W for the Wormhole.
        <br>
