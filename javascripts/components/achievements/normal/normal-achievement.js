...
const achDetails = [
  ...
  { name: "Not-so-challenging", imageId: 405, tooltip: () => "Get the sum of all of your challenge times under 3 minutes. Reward: All Dimensions are stronger in the first 3 minutes of infinities, but only in challenges." },
  ...
  { name: "You did this again just for the achievement right?", imageId: 408, tooltip: () => "Complete the Third Dimension Autobuyer challenge in 10 seconds or less. Reward: 1st Dimensions are 50% stronger." },

  { name: "ERROR 909: Dimension not found", imageId: 41, tooltip: () => "Get to Infinity with only a single 1st Dimension without Dimension Boosts/Shifts or Antimatter Galaxies, while in the Automatic Antimatter Galaxies Challenge. Reward: 1st Dimensions are 3 times stronger." },
  { name: "Can't hold all these infinities", imageId: 42, tooltip: () => "Get all Dimension multipliers over 1e308. Reward: All Dimensions are 10% stronger." },
  ...
  { name: "End me", imageId: 44, tooltip: () => "Get the sum of all best challenge times under 5 seconds. Reward: All Dimensions are 40% stronger, but only in challenges." },
  ...
  { name: "One for each dimension", imageId: 21, tooltip: () => "Play for 8 days. Reward: Extremely small multiplier to Dimensions based on time played." },
  { name: "How the antitables have turned", imageId: 47, tooltip: () => "Get the 8th Dimension multiplier to be highest, 7th Dimension multiplier second highest, etc. Reward: Each Dimension gains a boost proportional to tier (8th dimension gets 8%, 7th gets 7%, etc.)" },
  { name: "Blink of an eye", imageId: 48, tooltip: () => `Get to Infinity in under 200 milliseconds. Reward: Start with ${shortenCosts(1e25)} antimatter and all Dimensions are stronger in the first 300ms of Infinities.` },
  ...
  { name: "Ludicrous Speed", imageId: 57, tooltip: () => `Big Crunch for ${shortenCosts(1e200)} IP in 2 seconds or less. Reward: All Dimensions are significantly stronger in the first 5 seconds of Infinities.` },
  { name: "I brake for nobody", imageId: 58, tooltip: () => `Big Crunch for ${shortenCosts(1e250)} IP in 20 seconds or less. Reward: All Dimensions are significantly stronger in the first 60 seconds of Infinities.` },
  ...
  { name: "Costco sells dimboosts now", imageId: 65, tooltip: () => "Bulk buy 750 Dimension Boosts at once. Reward: Dimension Boosts are 1% more powerful (to Normal Dimensions)." },
  ...
  { name: "Infinite time", imageId: 69, tooltip: () => "Get 308 tickspeed upgrades (in one Eternity) from Time Dimensions. Reward: Time Dimensions are affected slightly by tickspeed." },
  ...
  { name: "Yo dawg, I heard you liked infinities...", imageId: 73, tooltip: () => `Have all your Infinities in your past 10 Infinities be at least ${shortenMoney(Number.MAX_VALUE)} times higher IP than the previous one. Reward: Your antimatter doesn't reset on Dimension Boost/Shift/Galaxy.` },
  { name: "Never again", imageId: 74, tooltip: () => "Max out your third Eternity upgrade. Reward: The limit for it is a bit higher." },
  ...
  { name: "Like feasting on a behind", imageId: 85, tooltip: () => `Reach ${shortenCosts(1e100)} IP without any Infinities or 1st Dimensions. Reward: IP multiplier based on time spent this Infinity.` },
  ...
  { name: "Unique snowflakes", imageId: 90, tooltip: () => "Have 630 Antimatter Galaxies without having any Replicanti Galaxies. Reward: Gain a multiplier to Dilated Time gain based on Antimatter Galaxies." },
  ...
  { name: "How does this work?", imageId: 98, tooltip: () => "Unlock the automator. Reward: Dimension Boosts are 50% more effective." },
  ...
  { name: "r145", imageId: 101, tooltip: () => "nothing to see here" },
  { name: "r146", imageId: 102, tooltip: () => "thanks" },
  { name: "r147", imageId: 103, tooltip: () => "todo: make this achievement a thing" },
  { name: "r148", imageId: 104, tooltip: () => "if you read this, ping me (or don't)" },
];