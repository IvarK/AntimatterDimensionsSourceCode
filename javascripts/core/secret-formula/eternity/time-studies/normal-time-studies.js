GameDatabase.eternity.timeStudies.normal = [
  ...
  },
  {
    ...
    effect: () => {
      ...
      if (PERKS.TS_IDLE_EP) {
        thisEternity = thisEternity.add(TimeSpan.fromMinutes(15))
      }
